...
import { Star, Flag, Share2, Gamepad2, Clock } from "lucide-react";
    ...
    <div className="w-full px-4 sm:px-6 lg:px-10 py-8">
      <div className="grid grid-cols-1 xl:grid-cols-[1fr_380px] gap-8">
        ...
        <div className="space-y-6">
          {/* Game Player */}
          <GamePlayer src={gameUrl} title={game.title} />
          ...
          <div className="glass-card rounded-xl p-6 space-y-4">
            <div className="flex items-start justify-between gap-4 flex-wrap">
              ...
              <div className="flex items-center gap-2">
                <div className="flex items-center gap-1.5 bg-yellow-400/10 border border-yellow-400/20 rounded-full px-3 py-1.5">
                  ...
                  <span className="text-yellow-300 font-semibold text-sm">{game.rating.toFixed(1)}</span>
                </div>
            ...
            <div className="flex items-center gap-3 pt-2 border-t border-white/5 flex-wrap">
              ...
              <div className="flex items-center gap-2 text-white/30 text-sm ml-auto">
